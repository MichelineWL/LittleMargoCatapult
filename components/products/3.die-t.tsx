  ...
  return (
    <section className="py-16">
      <div className="container mx-auto px-4">
        <div className="bg-[#D9D9D9] rounded-2xl p-8 flex flex-col gap-8">
          ...
          <div className="flex justify-center">
            <span className="bg-white px-8 py-2 rounded-full font-bold text-black text-xl">
              Ready-to-buy{' '}
              <span className="text-[#BC1E2C]">Die-T Series!</span>
            </span>
          </div>
          ...
          <div className="relative px-12">
            ...
            >
              ...
              <CarouselPrevious className="left-0 bg-[#BC1E2C] hover:bg-[#BC1E2C]/80 text-white" />
              <CarouselNext className="right-0 bg-[#BC1E2C] hover:bg-[#BC1E2C]/80 text-white" />
            </Carousel>
          </div>
        </div>
      </div>
